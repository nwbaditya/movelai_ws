...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/movelai_ws/devel/include;/movelai_ws/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include".split(';') if "/movelai_ws/devel/include;/movelai_ws/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include" != "" else []
