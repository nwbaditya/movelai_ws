...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/movelai_ws/src/navigation/move_slow_and_clear/include".split(';') if "/movelai_ws/src/navigation/move_slow_and_clear/include" != "" else []
