...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/movelai_ws/devel/include;/movelai_ws/src/navigation/dwa_local_planner/include".split(';') if "/movelai_ws/devel/include;/movelai_ws/src/navigation/dwa_local_planner/include" != "" else []
